...
{
      "acid rain", {28, 53, 35, 32}, {1, 1, 2, 2},
      spell_acid_rain, TAR_CHAR_OFFENSIVE, POS_FIGHTING,
      NULL, SLOT (99), 20, 12,
      "acid rain", "!Acid Rain!"},

{
	"cause elemental", {28, 53, 53, 32}, {1, 1, 2, 2},
	spell_cause_elemental, TAR_CHAR_OFFENSIVE, POS_FIGHTING,
	NULL, SLOT (98), 20, 12,
	"cause elemental", "!Cause Elemental!"}, 
...
const struct group_type group_table[MAX_GROUP] = {
...

    {
     ...
     {"demonfire", "dispel evil", "dispel good", "earthquake",
      "flamestrike", "heat metal", "acid rain", "ray of truth"}
     },
