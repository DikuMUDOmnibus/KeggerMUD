...
void qmconfig_read (void) {
	...
	logf("Loading configuration settings from ../area/qmconfig.rc.");
	...
	logf("Settings have been read from ../area/qmconfig.rc");
	exit(0);
