...
sprintf(log_buf,"%s has been killed by %s!", victim->name, ch->name);
do_info(ch,log_buf);
...
int xp_compute (CHAR_DATA * gch, CHAR_DATA * victim, int total_levels)
{
    ...
    xp = number_range (xp * 9 / 4, xp * 11 / 4);
                  ...
                  bool immune)
{
    ...
    else if (dam_percent <= 39)
    {
        vs = "MASSACRE";
        vp = "MASSACRES";
    }
    else if (dam_percent <= 42)
    {
        vs = "MANGLE";
        vp = "MANGLES";
    }
    ...
    else if (dam_percent <= 48)
    {
        vs = "*** DEVASTATE ***";
        vp = "*** DEVASTATES ***";
    }
    else if (dam_percent <= 51)
    {
        vs = "=== OBLITERATE ===";
        vp = "=== OBLITERATES ===";
    }
    else if (dam_percent <= 54)
    {
        vs = ">>> ANNIHILATE <<<";
        vp = ">>> ANNIHILATES <<<";
    }
    else if (dam_percent <= 57)
    {
        vs = "<<< ERADICATE >>>";
        vp = "<<< ERADICATES >>>";
    }
    ...
    else if (dam_percent <= 63)
    {
	vs = "do INCONCIEVABLE things to";
	vp = "does INCONCIEVABLE things to";
    }
    else if (dam_percent <= 66)
    {
	vs = "do UNGODLY things to";
	vp = "does UNGODLY things to";
    }
    else if (dam_percent <= 69)
    {
	vs = "do UNBELIEVABLE things to";
        vp = "does UNBELIEVABLE things to";
    }
    else if (dam_percent <= 72)
    {
	vs = "do UNHOLY things to";
	vp = "does UNHOLY things to";
    }
    else if (dam_percent <= 75)
    {
	vs = "do GODLIKE things to";
	vp = "does GODLIKE things to";
    }
    else
    {
	vs = "do ATOMITIZING things to";
	vp = "does ATOMITIZING things to";
    }
