...
#define QUEST_ITEM1 17000
#define QUEST_ITEM2 17001
#define QUEST_ITEM3 17002
#define QUEST_ITEM4 17003
#define QUEST_ITEM5 17004
...
#define QUEST_OBJQUEST1 17099
#define QUEST_OBJQUEST2 17098
#define QUEST_OBJQUEST3 17097
#define QUEST_OBJQUEST4 17096
#define QUEST_OBJQUEST5 17095
...
To buy an item, type 'QUEST BUY <item>'.\n\r");
	...
	else if (is_name(arg2, "silver "))
	{
	    if (ch->questpoints >= 500)
	    {
		ch->questpoints -= 500;
	        ch->silver += 350000;
    	        act( "$N gives 350,000 silver pieces to $n.", ch, NULL, questman, TO_ROOM );
    	        act( "$N has 350,000 in silver transfered from $s Swiss account to your balance.",   ch, NULL, questman, TO_CHAR );
	        return;
	    }
	    else
	    {
