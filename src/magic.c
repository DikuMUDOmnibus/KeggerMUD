...
{
act ("Waves of acid rain called by $n shower down upon $N!",ch,NULL,victim,TO_ROOM);
act ("Waves of acid rain shower down upon $N!",ch,NULL,victim,TO_CHAR);
...
void spell_cause_elemental (int sn, int level, CHAR_DATA * ch, void *vo, int target)
{
CHAR_DATA *victim = (CHAR_DATA *) vo;

act ("{GYou call the elements to pummel your foes!{x",ch, NULL, victim, TO_CHAR);
act ("{G$n calls upon the elements of the earth!{x", ch, NULL, victim, TO_ROOM);


damage (ch, (CHAR_DATA *) vo, dice (13, 40) + level - 6, sn, DAM_COLD, TRUE);

act ("{CA blast of frost called by $n drives into $N!{x", ch, NULL, victim, TO_ROOM);
act ("{CA blast of frost drives into $N!{x", ch, NULL, victim, TO_CHAR);

damage (ch, (CHAR_DATA *) vo, dice (13, 40) + level - 6, sn, DAM_FIRE, TRUE);

act ("{RA blast of fire called by $n drives into $N!{x", ch, NULL, victim, TO_ROOM);
act ("{RA blast of fire drives into $N!{x",ch,NULL,victim,TO_CHAR);

damage (ch, (CHAR_DATA *) vo, dice (13, 40) + level - 6, sn, DAM_ACID, TRUE);

act ("{rA blast of acid called by $n drives into $N!{x", ch, NULL, victim,TO_ROOM);
act ("{rA blast of acid drives into $N!{x", ch, NULL, victim, TO_CHAR);

damage (ch, (CHAR_DATA *) vo, dice (13, 40) + level - 6, sn, DAM_LIGHTNING, TRUE);

act ("{cA blast of lightning called by $n drives into $N!{x", ch, NULL, victim, TO_ROOM);
act ("{cA blast of lightning drives into $N!{x", ch, NULL, victim, TO_CHAR);
